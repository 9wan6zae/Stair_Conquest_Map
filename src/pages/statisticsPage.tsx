          ...
          <DetailInfo>
            ...
            <section className="userInfo">
              ...
              <section style={{marginTop: '44px'}}>
                ...
                {statistics.mostRegisteredUser?.instagramId && <p className="instagram">인스타그램 <a href={`https://www.instagram.com/${statistics.mostRegisteredUser?.instagramId.value}/`}><span>@{statistics.mostRegisteredUser?.instagramId.value}</span></a></p>}
              </section>
            </section>
